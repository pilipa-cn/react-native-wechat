...
const nativeShareAppletsToSession = wrapApi(WeChat.shareAppletsToSession);
...
//分享小程序
export function shareAppletsToSession(data) {
    // WeChat.shareAppletsToSession(data, result => {
    //
    // });
    // nativeShareAppletsToSession
    return new Promise((resolve, reject) => {
        nativeShareAppletsToSession(data);
        emitter.once('SendMessageToWX.Resp', resp => {
            if (resp.errCode === 0) {
                resolve(resp);
            } else {
